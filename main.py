...
char_font = pygame.font.SysFont("comicsansms", 31, bold=True)
small_back_font = pygame.font.SysFont("comicsansms", 28, bold=True)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if menu:
                ...
                if play_button.collidepoint(event.pos):
                    menu = False
                    level = Level1(screen, character_paths[selected_character])
